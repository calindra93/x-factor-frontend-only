...
/** @typedef {{ VITE_BASE44_APP_ID?: string, VITE_BASE44_FUNCTIONS_VERSION?: string, VITE_BASE44_APP_BASE_URL?: string }} AppEnv */
...
/** @type {AppEnv} */
const env = /** @type {{ env?: AppEnv }} */ (import.meta).env ?? {};
