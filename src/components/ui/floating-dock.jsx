  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
            ...
            {items.map((item, idx) => (
              ...
              >
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-[#1a1a2e] dark:bg-neutral-900"
                >
      ...
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full bg-[#1a1a2e] dark:bg-neutral-800"
      >
        ...
        <AnimatePresence>
          {hovered && (
            <motion.div
              ...
              className="absolute -top-8 left-1/2 w-fit rounded-md border border-white/10 bg-[#1a1a2e] px-2 py-0.5 text-xs whitespace-pre text-neutral-200"
            >
              {title}
            </motion.div>
          )}
