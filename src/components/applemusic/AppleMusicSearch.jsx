...
export default function AppleMusicSearch({ artists, onSelectArtist }) {
  ...
  return (
    <div className="px-4 py-6 space-y-4">
      {/* Search Bar */}
      <div className="sticky top-0 z-20 bg-[#0a0a0f] pb-4">
      ...
      <div className="space-y-2">
        {filteredArtists.length === 0 ? (
          ...
          filteredArtists.map((artist, idx) => (
            ...
            >
              <div className="h-12 w-12 rounded-full bg-gradient-to-br from-red-600 to-orange-600 flex items-center justify-center flex-shrink-0 overflow-hidden">
                {artist.artist_image ? (
                  <img
